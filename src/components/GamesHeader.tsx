...
const GamesHeader: React.FC = () => (
  <div className="flex flex-col items-center mb-8 relative">
    ...
    <p className="text-lg md:text-xl text-neutral-700 mt-2 text-center max-w-3xl mx-auto">
      Learn nutrition the fun way! Explore interactive games designed for Indian diets, powered by Zestly's advanced AI. Earn rewards, challenge friends, and boost your healthy eating knowledge.
    </p>
  </div>
);
